...
const exstracted = books.slice(0, 36)     //change exstracted to exstracted

for ({ author, image, title, id }; exstracted; i++) {   //changed exstracted to exstracted
...
// datalistclose.click() { datalistactive.open === false }
...
//     const extracted = source.slice(range[0], range[1])  //change extracted to info

//     for ({ author, image, title, id }; extracted; i++) {  //change extracted into 
